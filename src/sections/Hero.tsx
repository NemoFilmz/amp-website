...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden grain pt-[100px] pb-10">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, rgba(32,33,36,0.62) 0%, rgba(32,33,36,0.40) 34%, rgba(32,33,36,0.80) 82%, rgba(32,33,36,1) 100%)',
        }}
      />
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          {motionItem(
            'mt-24 flex flex-wrap items-center gap-3',
            <>
              {HERO.ctas.map((c) =>
                c.variant === 'primary' ? (
